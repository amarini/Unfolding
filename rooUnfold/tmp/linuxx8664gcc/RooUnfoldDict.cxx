...
#define R__DICTIONARY_FILENAME dIafsdIcerndOchdIuserdIadIamarinidIworkdIRooUnfolddItmpdIlinuxx8664gccdIRooUnfoldDict
...
#include "src/RooUnfoldBasisSplines.h"
...
namespace ROOT {
   static void *new_RooUnfoldBasisSplines(void *p = 0);
   static void *newArray_RooUnfoldBasisSplines(Long_t size, void *p);
   static void delete_RooUnfoldBasisSplines(void *p);
   static void deleteArray_RooUnfoldBasisSplines(void *p);
   static void destruct_RooUnfoldBasisSplines(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::RooUnfoldBasisSplines*)
   {
      ::RooUnfoldBasisSplines *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::RooUnfoldBasisSplines >(0);
      static ::ROOT::TGenericClassInfo 
         instance("RooUnfoldBasisSplines", ::RooUnfoldBasisSplines::Class_Version(), "RooUnfoldBasisSplines.h", 29,
                  typeid(::RooUnfoldBasisSplines), DefineBehavior(ptr, ptr),
                  &::RooUnfoldBasisSplines::Dictionary, isa_proxy, 4,
                  sizeof(::RooUnfoldBasisSplines) );
      instance.SetNew(&new_RooUnfoldBasisSplines);
      instance.SetNewArray(&newArray_RooUnfoldBasisSplines);
      instance.SetDelete(&delete_RooUnfoldBasisSplines);
      instance.SetDeleteArray(&deleteArray_RooUnfoldBasisSplines);
      instance.SetDestructor(&destruct_RooUnfoldBasisSplines);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::RooUnfoldBasisSplines*)
   {
      return GenerateInitInstanceLocal((::RooUnfoldBasisSplines*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::RooUnfoldBasisSplines*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::RooUnfoldSvd*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("RooUnfoldSvd", ::RooUnfoldSvd::Class_Version(), "RooUnfoldSvd.h", 26,
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TSVDUnfold_130729*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TSVDUnfold_130729", ::TSVDUnfold_130729::Class_Version(), "TSVDUnfold_local.h", 58,
                  typeid(::TSVDUnfold_130729), DefineBehavior(ptr, ptr),
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfold*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBayes*)0x0)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
atomic_TClass_ptr RooUnfoldBasisSplines::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *RooUnfoldBasisSplines::Class_Name()
{
   return "RooUnfoldBasisSplines";
}

//______________________________________________________________________________
const char *RooUnfoldBasisSplines::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBasisSplines*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int RooUnfoldBasisSplines::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBasisSplines*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *RooUnfoldBasisSplines::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBasisSplines*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *RooUnfoldBasisSplines::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBasisSplines*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldSvd*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldBinByBin*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldResponse*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldErrors*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldParms*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldInvert*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooUnfoldTUnfold*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSVDUnfold_130729*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void RooUnfoldBasisSplines::Streamer(TBuffer &R__b)
{
   // Stream an object of class RooUnfoldBasisSplines.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(RooUnfoldBasisSplines::Class(),this);
   } else {
      R__b.WriteClassBuffer(RooUnfoldBasisSplines::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_RooUnfoldBasisSplines(void *p) {
      return  p ? new(p) ::RooUnfoldBasisSplines : new ::RooUnfoldBasisSplines;
   }
   static void *newArray_RooUnfoldBasisSplines(Long_t nElements, void *p) {
      return p ? new(p) ::RooUnfoldBasisSplines[nElements] : new ::RooUnfoldBasisSplines[nElements];
   }
   // Wrapper around operator delete
   static void delete_RooUnfoldBasisSplines(void *p) {
      delete ((::RooUnfoldBasisSplines*)p);
   }
   static void deleteArray_RooUnfoldBasisSplines(void *p) {
      delete [] ((::RooUnfoldBasisSplines*)p);
   }
   static void destruct_RooUnfoldBasisSplines(void *p) {
      typedef ::RooUnfoldBasisSplines current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::RooUnfoldBasisSplines
...
"/afs/cern.ch/user/a/amarini/work/RooUnfold/src/",
"/afs/cern.ch/user/a/amarini/work/RooUnfold",
...
class __attribute__((annotate(R"ATTRDUMP(Unfolding base class: implementations in RooUnfoldBayes, RooUnfoldSvd, RooUnfoldBinByBin, RooUnfoldTUnfold, and RooUnfoldInvert)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/RooUnfold.h")))  RooUnfold;
...
class __attribute__((annotate("$clingAutoload$src/RooUnfoldBasisSplines.h")))  RooUnfoldBasisSplines;
...
class __attribute__((annotate(R"ATTRDUMP(Respose Matrix)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/RooUnfold.h")))  RooUnfoldResponse;
...
class __attribute__((annotate(R"ATTRDUMP(Data unfolding using Singular Value Decomposition (hep-ph/9509307))ATTRDUMP"))) __attribute__((annotate("$clingAutoload$src/TSVDUnfold_local.h")))  TSVDUnfold_130729;
)DICTFWDDCLS";
...
"RooUnfoldBasisSplines", payloadCode, "@",
