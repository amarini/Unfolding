...
void makeSystHistPt2(int nsel = 0, int whichDY = 1){
  ...
  TFile *_file7 = TFile::Open(Form("output/histoUnfoldingPt2_nsel%d_dy%d_rebin1_lepeff.root",nsel,version)); // LepEff
  ...
  histAlt[6] = (TH1D*)_file7->Get(Form("histoPt2RecGen_%d",nsel));
