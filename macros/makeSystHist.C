...
void makeSystHist(int nsel = 0, int isLO = 0){
  gStyle->SetOptStat(0);
  int version = 1; int alternative = 0;
  if(isLO == 0) { version = 0; alternative = 1;}
  ...
  TFile *_file0 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_default.root",nsel,version)); // default NLO/LO
  TFile *_file1 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_default.root",nsel,alternative)); // alternative LO/NLO
  TFile *_file2 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_svd40.root",nsel,version)); // SVD alt
  TFile *_file3 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_bayes10.root",nsel,version)); // Bayes alt
  TFile *_file4 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_monres.root",nsel,version)); // MonRes
  TFile *_file5 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_pdf.root",nsel,version)); // PDF bkg
  TFile *_file6 = TFile::Open(Form("output/histoUnfolding_nsel%d_lo%d_rebin1_qcd.root",nsel,version)); // QCD bkg.
